...
The general playbook can be summarized by: 0--{GPT-4}--> 1--{Fine-tuned model}--> 100.
...
This applies to your critic and healer LLMs as well, to get those as aligned as possible to your expert, they need constant reiteration.
